	...
	return (
		<main>
			...
			<div className="container sm:mx-auto md:mx-auto privacy-page bg-transparent text-white">
				<div className="grid grid-cols-1 py-10 mx-auto md:mx-20 justify-center">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">WHAT PERSONAL INFORMATION WE COLLECT</h3>
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">HOW WE USE YOUR PERSONAL INFORMATION</h3>
					<p className="my-1 aktiv-grotesk-regular">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">Additionally, we use this Order Information to:</h3>
					<ul className="list-disc mx-5 aktiv-grotesk-regular">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">SHARING YOUR PERSONAL INFORMATION</h3>
					<p className="my-1 aktiv-grotesk-regular">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">BEHAVIOURAL ADVERTISING</h3>
					<p className="my-1 aktiv-grotesk-regular">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">YOUR RIGHTS</h3>
					<p className="my-1 aktiv-grotesk-regular">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">DATA RETENTION</h3>
					<p className="my-1 aktiv-grotesk-regular">
					...
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">USE BY MINORS</h3>
					<p className="my-1 aktiv-grotesk-regular">The Site is not intended for individuals under the age of 16.</p>
					<h3 className="font-bold mt-3 mb-2 aktiv-grotesk-semibold">CHANGES</h3>
					<p className="my-1 aktiv-grotesk-regular">
