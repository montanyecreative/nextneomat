				...
				<div className="container webdev-page mx-auto text-center text-white">
					<div className="webdev-intro">
						...
						<p className="my-2 mx-auto sm:mx-5 md:mx-unset">
							...
							<i>
								Citizen, Bulova, Accutron, New Balance, Johnston &amp; Murphy, Sheet Music Plus, Cherished Memories,
								ReserveBar, LuxeDecor, SyllogisTeks, PohlmanUSA, and Our Lady&apos;s Inn
							</i>
							. See{" "}
