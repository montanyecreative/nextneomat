...
export default function ExperienceSection() {
    ...
    var currentJobYears = yearDiff(new Date(currentJobStartYear, 10), new Date());
    ...
    var currentSideJobYears = yearDiff(new Date(currentSideJobStartYear, 1), new Date());
        ...
        <div className="resume-intro text-left" id="experience">
            ...
            <div className="job border-t py-4">
                ...
                <div className="company-section">
                    ...
                    <div className="flex">
                        <Image src={newbalanceLogo} className="job-logo" alt="New Balance logo" width="30" height="25" />
                        <h4 className="text-[20px] mb-2 ml-2">
                    ...
                    <div className="flex py-1 mt-3">
                        <svg width="24" height="24" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.49991 0.876892C3.84222 0.876892 0.877075 3.84204 0.877075 7.49972C0.877075 11.1574 3.84222 14.1226 7.49991 14.1226C11.1576 14.1226 14.1227 11.1574 14.1227 7.49972C14.1227 3.84204 11.1576 0.876892 7.49991 0.876892ZM7.00003 1.84861C4.10114 2.1017 1.82707 4.53515 1.82707 7.49972C1.82707 10.4643 4.10114 12.8977 7.00003 13.1508V1.84861ZM8.00003 13.1508C10.8988 12.8976 13.1727 10.4642 13.1727 7.49972C13.1727 4.53524 10.8988 2.10185 8.00003 1.84864V13.1508Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
                        <p className="text-[18px] ml-1">
                    ...
                    <p className="ml-5">
                        <i>
                            Clients include internal and PohlmanUSA.
                        </i>
                    </p>
                    <p className="ml-5 mt-1">
            ...
            <div className="job border-t py-4">
                <div className="flex py-1">
                    ...
                    <p className="text-[18px] ml-1">
                        March 2023 - Current (
                        {currentSideJobYears ? currentSideJobYears + "year" : ""}
                        {amountSideJobMonths}{" "}
                        {amountSideJobMonths > 1 ? "months" : "month"})
                    </p>
                </div>
                <div className="company-section">
                    <div className="flex">
            ...
            <div className="job border-t py-4">
                ...
                <div className="company-section">
                    ...
                    <p className="ml-5">
                        <i>
                            Clients include internal and Our Lady's Inn.
                        </i>
                    </p>
                    <p className="ml-5 mt-1">
